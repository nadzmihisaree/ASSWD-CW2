...
<section class= "mt-5 pt-5">
    <div class="row m-0 mt-5">
        <div class="col-3 align-items-center d-flex flex-column">
            <div class="px-3 position-fixed align-items-center d-flex flex-column">
                <img src="" class="user_profile" alt="">
                <h3 id="uname" class="my-3"></h3>
                <p id = "desc" class="m-0 text-center"></p>
                <a href="<?php echo base_url() ?>Profile"><button class="bg-transparent mt-5 p-3" style="border-radius: 13px;">View Profile</button></a>
            </div>
...
<script>
    ...
    $(document).ready(function(){
        $('#uname').text(username);
        $('#desc').text(desc);
        // $('.user_profile').attr('src', '../assets/images/user_profile.png');
            ...
            for (var i = 0; i < response.length; i++) {
                ...
                $('#home_card').append(`
                    <div class="col-10  mx-auto p-4 home_card mb-4" >
                        ...
                        <div class="">
                            <img class="" src="http://localhost/CWK2/postImages/${image}" alt="" style = " object-fit: cover; height: 350px; width: 100%;">
                            <div class="mt-2">
